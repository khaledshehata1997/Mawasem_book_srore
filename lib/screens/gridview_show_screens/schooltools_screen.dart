...
class SchoolToolsScreen extends StatefulWidget {
  static String routeName = '/SchoolToolsScreen';
  @override
  _SchoolToolsScreenState createState() => _SchoolToolsScreenState();
}

class _SchoolToolsScreenState extends State<SchoolToolsScreen> {
  int pageChanged = 0;
