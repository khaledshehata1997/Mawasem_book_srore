...
class LibToolScreen extends StatefulWidget {
  static String routeName = '/LibToolScreen';
  @override
  _SchoolToolsScreenState createState() => _SchoolToolsScreenState();
}

class _SchoolToolsScreenState extends State<LibToolScreen> {
  int pageChanged = 0;
