...
class ArtsToolScreen extends StatefulWidget {
  static String routeName = '/ArtsToolScreen';
  @override
  _SchoolToolsScreenState createState() => _SchoolToolsScreenState();
}

class _SchoolToolsScreenState extends State<ArtsToolScreen> {
  int pageChanged = 0;
