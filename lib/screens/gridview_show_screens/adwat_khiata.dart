...
class KhiataToolScrren extends StatefulWidget {
  static String routeName = '/KhiataToolScrren';
  @override
  _KhiataToolScrrenState createState() => _KhiataToolScrrenState();
}

class _KhiataToolScrrenState extends State<KhiataToolScrren> {
  int pageChanged = 0;
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            children: <Widget>[
                              ...
                              Text("رس${snapshot.data[index].regular_price.toString()}",
                                  style: TextStyle(
