...
class AlbouaBakhakhScreen extends StatefulWidget {
  static String routeName = '/AlbouaBakhakhScreen';
  @override
  _SchoolToolsScreenState createState() => _SchoolToolsScreenState();
}

class _SchoolToolsScreenState extends State<AlbouaBakhakhScreen> {
  int pageChanged = 0;
