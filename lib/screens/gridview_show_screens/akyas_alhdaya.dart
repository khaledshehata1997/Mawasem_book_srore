...
class AkyasAlhadayaScreen extends StatefulWidget {
  static String routeName = '/AkyasAlhadayaScreen';
  @override
  _SchoolToolsScreenState createState() => _SchoolToolsScreenState();
}

class _SchoolToolsScreenState extends State<AkyasAlhadayaScreen> {
  int pageChanged = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('أكياس وتغليف الهدايا',
