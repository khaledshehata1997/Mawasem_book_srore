...
class AlqrtasiasScreen extends StatefulWidget {
  static String routeName = '/AlqrtasiasScreen';
  @override
  _SchoolToolsScreenState createState() => _SchoolToolsScreenState();
}

class _SchoolToolsScreenState extends State<AlqrtasiasScreen> {
  int pageChanged = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: FutureBuilder(
            future: fetchStationeryAndNotebooks(),
