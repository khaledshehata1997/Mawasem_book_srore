...
class ElectronicGamesScreen extends StatefulWidget {
  static String routeName = '/ElectronicGamesScreen';
  @override
  _SchoolToolsScreenState createState() => _SchoolToolsScreenState();
}

class _SchoolToolsScreenState extends State<ElectronicGamesScreen> {
  int pageChanged = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('الألعاب الالكترونية',
