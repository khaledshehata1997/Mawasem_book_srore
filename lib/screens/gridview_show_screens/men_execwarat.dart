...
class MenExecwaratScreen extends StatefulWidget {
  static String routeName = '/MenExecwaratScreen';
  @override
  _SchoolToolsScreenState createState() => _SchoolToolsScreenState();
}

class _SchoolToolsScreenState extends State<MenExecwaratScreen> {
  int pageChanged = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('الإكسسورات الرجالية',
