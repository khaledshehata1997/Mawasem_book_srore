...
class TagaleedScreen extends StatefulWidget {
  static String routeName = '/TagaleedScreen';
  @override
  _SchoolToolsScreenState createState() => _SchoolToolsScreenState();
}

class _SchoolToolsScreenState extends State<TagaleedScreen> {
  int pageChanged = 0;
