...
class AtfalGamessScreen extends StatefulWidget {
  static String routeName = '/AtfalGamessScreen';
  @override
  _SchoolToolsScreenState createState() => _SchoolToolsScreenState();
}

class _SchoolToolsScreenState extends State<AtfalGamessScreen> {
  int pageChanged = 0;
